...
#CXXFLAGS_append_nanopi-neo2 = " -O3 -ffast-math -fno-finite-math-only -fprefetch-loop-arrays -funroll-loops -funsafe-loop-optimizations -static-libstdc++ -Wl,-Ofast -Wl,--as-needed -Wl,--strip-all"
#LDFLAGS_append_nanopi-neo2 = " -static-libstdc++ -Wl,-Ofast -Wl,--as-needed -Wl,--strip-all"
